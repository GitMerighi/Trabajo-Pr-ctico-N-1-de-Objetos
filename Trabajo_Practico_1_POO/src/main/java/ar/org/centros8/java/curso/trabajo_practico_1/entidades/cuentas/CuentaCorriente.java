...
public class CuentaCorriente extends Cuenta {
    ...
    @Override
    /**
     * Este metodo se encarga de extraer dinero de la cuenta corriente. Si no se
     * llega con el saldo, ahi se retira por giroDescubierto con un tope en el
     * descubierto
     *
    ...
    /**
     * Método depositar cheque Primero crear el cheque y luego usar el metodo.
     *
